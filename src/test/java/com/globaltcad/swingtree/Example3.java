        ...
        .add("cell 0 1, grow, shrinky",
            ...
            .add("cell 0 0, aligny top, grow x, grow y",
                UI.panelWithLayout("fill, insets 7","grow")
                    ...
                    .add("grow",
                        UI.splitButton("Hey!")
                        .onButtonClick(it -> it.getDelegate().displayCurrentItemText() )
                        .onSplitClick(it -> it.getDelegate().displayCurrentItemText() )
                        .onSelection(
                            it -> it.getDelegate()
                        ...
                        .add(UI.splitRadioItem("first")
                            .onButtonClick(it -> it.getDelegate().getCurrentItem().setText(":P") )
                        )
