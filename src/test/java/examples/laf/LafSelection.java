 ...
 *
 *  <p>This is the same shape of problem {@link LafFocus} exists for, and it
 ...
 *  @see LafFocus
 */
final class LafSelection
{
    private LafSelection() {}
    ...
    private static final String LISTENER = "swingtree.laf.selectionRepaint.listener";
