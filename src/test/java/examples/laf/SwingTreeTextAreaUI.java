...
/**
 *  The {@link JTextArea} UI delegate. A text area is usually mounted inside a scroll pane;
 *  in that arrangement the area renders the field surface while the scroll pane carries the
 *  outer frame.
 *  <p>
 *  Painting takes the document read lock the way {@link SwingTreeTextFieldUI} describes.
 */
public final class SwingTreeTextAreaUI
        extends    BasicTextAreaUI
        implements SwingTreeStyledComponentUI<JTextArea>
{
    /** Called by Swing reflectively to make the delegate. */
    public static ComponentUI createUI( JComponent c ) { return new SwingTreeTextAreaUI(); }
    ...
    @Override
    public ComponentStyleDelegate<JTextArea> style( ComponentStyleDelegate<JTextArea> it ) throws Exception {
