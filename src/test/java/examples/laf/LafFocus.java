 ...
 *  {@link swingtree.api.laf.SwingTreeStyledComponentUI#style style(..)} only while that
...
final class LafFocus {
     ...
     *  surrounding spinner. */
    private static final String LISTENER = "swingtree.laf.focusRepaint.listener";
