...
final class CarvedSymbols implements Symbols
{
    ...
    public void paintCheckGlyph(
        ...
        g.fill(new RoundRectangle2D.Float(x, y + 1, w - 1, h - 1, arc, arc));
    ...
    public void paintScrollThumb( Graphics2D g, Palette p, Rectangle r, boolean active ) {
        ...
        g.fill(new RoundRectangle2D.Float(body.x, body.y + 1, body.width, body.height, arc, arc));
        g.setPaint(LafUtilities.glossGradient(body.y, body.height, base));
        g.fill(new RoundRectangle2D.Float(body.x, body.y, body.width, body.height, arc, arc));
        g.setColor(p.border());
        g.setStroke(new BasicStroke(1f));
    ...
    public void paintTabSurface(
        ...
        g.fill(new RoundRectangle2D.Float(x, y + 1, w, h, arc, arc));
