        ...
        implements SwingTreeStyledComponentUI<JTextPane>
{
    ...
    SwingTreeTextPaneUI( SwingTreeLookAndFeel.Theme theme ) { _theme = theme; }

    public static ComponentUI createUI( JComponent c ) { return new SwingTreeTextPaneUI(SwingTreeLookAndFeel.installedTheme()); }
