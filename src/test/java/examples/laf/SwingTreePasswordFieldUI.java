        ...
        implements SwingTreeStyledComponentUI<JPasswordField>
{
    ...
    SwingTreePasswordFieldUI( SwingTreeLookAndFeel.Theme theme ) { _theme = theme; }

    public static ComponentUI createUI( JComponent c ) { return new SwingTreePasswordFieldUI(SwingTreeLookAndFeel.installedTheme()); }
