...
public final class TabSelectionExample1 extends Panel {
    ...
    public TabSelectionExample1(TabsViewModel vm) {
        ...
        .add(GROW,
            ...
            .add(
                ...
                .isSelectedIf(vm.currentTab().is(TabType.STATUS))
                .add(
            ...
            .add(
                ...
                .isSelectedIf(vm.currentTab().is(TabType.BIO))
                .add(
                    panel(FILL_X.and(WRAP(1)), "[grow]")
            ...
            .add(
                ...
                .isSelectedIf(vm.currentTab().is(TabType.DETAILS))
                .add(
                    panel(FILL_X.and(WRAP(1)), "[grow]")
    ...
    public static void main(String[] args) {
        ...
        UI.show( f -> new TabSelectionExample1(vm) );
    }
