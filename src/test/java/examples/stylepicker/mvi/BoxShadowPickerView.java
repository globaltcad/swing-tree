        ...
        .add(
            ...
            .add(GROW_X.and(GROW_Y),
                ...
                .add(GROW_X,
                    ...
                    .add(label("Top:"))
                    .add(GROW_X, slider(Axis.HORIZONTAL, -50, 100, paddingTop))
                    .add(label(paddingTop.viewAsString()))
                    .add(label("Left:"))
                    .add(GROW_X, slider(Axis.HORIZONTAL, -50, 100, paddingLeft))
                    .add(label(paddingLeft.viewAsString()))
                    .add(label("Right:"))
                    .add(GROW_X, slider(Axis.HORIZONTAL, -50, 100, paddingRight))
                    .add(label(paddingRight.viewAsString()))
                    .add(label("Bottom:"))
                    .add(GROW_X, slider(Axis.HORIZONTAL, -50, 100, paddingBottom))
                    .add(label(paddingBottom.viewAsString()))
                )
                .add(GROW_X,
                    panel(FILL.and(WRAP(3)), "[shrink][grow][shrink]").withBorderTitled("Margin")
                    .add(label("Top:"))
                    .add(GROW_X, slider(Axis.HORIZONTAL, -25, 150, marginTop))
                    .add(label(marginTop.viewAsString()))
                    .add(label("Left:"))
                    .add(GROW_X, slider(Axis.HORIZONTAL, -25, 350, marginLeft))
                    .add(label(marginLeft.viewAsString()))
                    .add(label("Right:"))
                    .add(GROW_X, slider(Axis.HORIZONTAL, -25, 350, marginRight))
                    .add(label(marginRight.viewAsString()))
                    .add(label("Bottom:"))
                    .add(GROW_X, slider(Axis.HORIZONTAL, -25, 150, marginBottom))
                ...
                .add(GROW_X.and(SPAN),
                    ...
                    .add(
                        ...
                        .add(GROW_X, slider(Axis.HORIZONTAL, -50, 50, horizontalShadowOffset))
                        .add(label(horizontalShadowOffset.viewAsString()))
                        .add(label("Vertical Offset:"))
                        .add(GROW_X, slider(Axis.HORIZONTAL, -50, 50, verticalShadowOffset))
                        .add(label(verticalShadowOffset.viewAsString()))
                        .add(label("Blur Radius:"))
                        .add(GROW_X, slider(Axis.HORIZONTAL, -10, 100, shadowBlurRadius))
                        .add(label(shadowBlurRadius.viewAsString()))
                        .add(label("Spread Radius:"))
                        .add(GROW_X, slider(Axis.HORIZONTAL, -10, 100, shadowSpreadRadius))
            ...
            .add(GROW_X.and(GROW_Y),
                ...
                .add(SPAN,
                    ...
                    .add(SPAN,
                        ...
                        .add(UI.label("Width:"))
                        .add(GROW_X, UI.slider(Axis.HORIZONTAL, 0, 100, borderArcWidth))
                        .add(UI.label("Height:"))
                        .add(GROW_X, UI.slider(Axis.HORIZONTAL, 0, 100, borderArcHeight))
                    )
                )
                .add(SPAN,
                    ...
                    .add(SPAN,
                        ...
                        .add(UI.label("Width:"))
                        .add(GROW_X.and(SPAN(2)), UI.slider(Axis.HORIZONTAL, 0, 100, borderWidth))
                        .add(label("Color:"))
                        .add(GROW_X.and(PUSH_X),
