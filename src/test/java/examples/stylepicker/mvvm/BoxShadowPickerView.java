        ...
        .add(
            ...
            .add(GROW_X.and(GROW_Y),
                ...
                .add(GROW_X,
                    ...
                    .add(label("Top:"))
                    .add(GROW_X, slider(Axis.HORIZONTAL, -50, 100, vm.paddingTop()))
                    .add(label(vm.paddingTop().viewAsString()))
                    .add(label("Left:"))
                    .add(GROW_X, slider(Axis.HORIZONTAL, -50, 100, vm.paddingLeft()))
                    .add(label(vm.paddingLeft().viewAsString()))
                    .add(label("Right:"))
                    .add(GROW_X, slider(Axis.HORIZONTAL, -50, 100, vm.paddingRight()))
                    .add(label(vm.paddingRight().viewAsString()))
                    .add(label("Bottom:"))
                    .add(GROW_X, slider(Axis.HORIZONTAL, -50, 100, vm.paddingBottom()))
                    .add(label(vm.paddingBottom().viewAsString()))
                )
                .add(GROW_X,
                    panel(FILL.and(WRAP(3)), "[shrink][grow][shrink]").withBorderTitled("Margin")
                    .add(label("Top:"))
                    .add(GROW_X, slider(Axis.HORIZONTAL, -25, 150, vm.marginTop()))
                    .add(label(vm.marginTop().viewAsString()))
                    .add(label("Left:"))
                    .add(GROW_X, slider(Axis.HORIZONTAL, -25, 350, vm.marginLeft()))
                    .add(label(vm.marginLeft().viewAsString()))
                    .add(label("Right:"))
                    .add(GROW_X, slider(Axis.HORIZONTAL, -25, 350, vm.marginRight()))
                    .add(label(vm.marginRight().viewAsString()))
                    .add(label("Bottom:"))
                    .add(GROW_X, slider(Axis.HORIZONTAL, -25, 150, vm.marginBottom()))
                ...
                .add(GROW_X.and(SPAN),
                    ...
                    .add(
                        ...
                        .add(GROW_X, slider(Axis.HORIZONTAL, -50, 50, vm.horizontalShadowOffset()))
                        .add(label(vm.horizontalShadowOffset().viewAsString()))
                        .add(label("Vertical Offset:"))
                        .add(GROW_X, slider(Axis.HORIZONTAL, -50, 50, vm.verticalShadowOffset()))
                        .add(label(vm.verticalShadowOffset().viewAsString()))
                        .add(label("Blur Radius:"))
                        .add(GROW_X, slider(Axis.HORIZONTAL, -10, 100, vm.shadowBlurRadius()))
                        .add(label(vm.shadowBlurRadius().viewAsString()))
                        .add(label("Spread Radius:"))
                        .add(GROW_X, slider(Axis.HORIZONTAL, -10, 100, vm.shadowSpreadRadius()))
            ...
            .add(GROW_X.and(GROW_Y),
                ...
                .add(SPAN,
                    ...
                    .add(SPAN, vm.currentCornerModel(), viewModel ->
                        ...
                        .add(UI.label("Width:"))
                        .add(GROW_X, UI.slider(UI.Axis.HORIZONTAL, 0, 100, viewModel.borderArcWidth()))
                        .add(UI.label("Height:"))
                        .add(GROW_X, UI.slider(UI.Axis.HORIZONTAL, 0, 100, viewModel.borderArcHeight()))
                    )
                )
                .add(SPAN,
                    ...
                    .add(SPAN, vm.currentEdgeModel(), viewModel ->
                        ...
                        .add(UI.label("Width:"))
                        .add(GROW_X.and(SPAN(2)), UI.slider(UI.Axis.HORIZONTAL, 0, 100, viewModel.borderWidth()))
                        .add(label("Color:"))
                        .add(GROW_X.and(PUSH_X),
                ...
                .add(GROW,
                    ...
                    .withStyle( it -> it
                         ...
                         .painter(UI.Layer.BACKGROUND, g2d -> {
                             ...
                             int w = it.componentWidth() - vm.marginLeft().get() - vm.marginRight().get() - 100;
                             int h = it.componentHeight() - vm.marginTop().get() - vm.marginBottom().get() - 100;
