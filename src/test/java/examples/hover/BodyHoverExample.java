...
@NullMarked
public class BodyHoverExample extends JPanel {
    private static final Logger log = org.slf4j.LoggerFactory.getLogger(BodyHoverExample.class);
    ...
    private static void printAndDispatchIndicationAnimation( ComponentMouseEventDelegate<?> delegate, String info ) {
        ...
        delegate.animateFor(0.25, java.util.concurrent.TimeUnit.SECONDS, status -> {
            ...
            delegate.paint(ComponentArea.BODY, status, g -> {
        ...
        of(this).withLayout("wrap 2, fill", "[]40[]", "[]40[]")
            .add(
                ...
                .add("grow",
                    ...
                    .onMouseEnter(ComponentArea.BODY, it -> printAndDispatchIndicationAnimation(it, "root -> enter"))
                    .onMouseExit(ComponentArea.BODY, it -> printAndDispatchIndicationAnimation(it, "root -> exit "))
                    .onMouseEnter(ComponentArea.BODY, changeBackground(COLOR_1_HOVER))
                    .onMouseExit(ComponentArea.BODY, changeBackground(COLOR_1))
                    .add(GROW,
                        panel().withStyle(it->it.margin(12).borderRadius(12).foundationColor("black"))
                        .add(html("child 1<br>with listener"))
                        .withBackground(COLOR_2)
                        .onMouseEnter(ComponentArea.BODY, it -> printAndDispatchIndicationAnimation(it, "  child 1 -> enter"))
                        .onMouseExit(ComponentArea.BODY, it -> printAndDispatchIndicationAnimation(it, "  child 1 -> exit"))
                        .onMouseEnter(ComponentArea.BODY, changeBackground(COLOR_2_HOVER))
                        .onMouseExit(ComponentArea.BODY, changeBackground(COLOR_2))
                    )
                    .add(GROW,
                        panel().withStyle(it->it.margin(12).borderRadius(12).foundationColor("black"))
                        .add(html("child 2<br>with listener"))
                        .withBackground(COLOR_2)
                        .onMouseEnter(ComponentArea.BODY, it -> printAndDispatchIndicationAnimation(it, "  child 2 -> enter"))
                        .onMouseExit(ComponentArea.BODY, it -> printAndDispatchIndicationAnimation(it, "  child 2 -> exit"))
                        .onMouseEnter(ComponentArea.BODY, changeBackground(COLOR_4_HOVER))
                        .onMouseExit(ComponentArea.BODY, changeBackground(COLOR_2))
                    )
                    .add(GROW,
                    ...
                    .add(GROW,
                        ...
                        .withBackground(COLOR_2)
                        .onMouseEnter(ComponentArea.BODY, it -> printAndDispatchIndicationAnimation(it, "  child 4 -> enter"))
                        .onMouseExit(ComponentArea.BODY, it -> printAndDispatchIndicationAnimation(it, "  child 4 -> exit"))
                        .onMouseEnter(ComponentArea.BODY, changeBackground(COLOR_3_HOVER))
                        .onMouseExit(ComponentArea.BODY, changeBackground(COLOR_2))
                    )
                )
            )
