	...
	public JFrameView() {
		...
		.add(
			...
			.add(
				...
				.onKeyPress( it -> System.out.println("Button key pressed: " + it.getEvent().getKeyChar() ) )
				.onKeyRelease( it -> System.out.println("Button key released: " + it.getEvent().getKeyChar()) )
