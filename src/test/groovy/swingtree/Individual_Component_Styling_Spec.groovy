...
import examples.tabs.mvvm.MyTabsView
import examples.tabs.mvvm.MyTabsViewModel
...
class Individual_Component_Styling_Spec extends Specification
{
    ...
    def 'A single image can be painted repeatedly in a panel.'()
    {
        ...
        then : 'The image is rendered as expected.'
            Utility.similarityBetween(images, "components/repeated-image-label-collage.png", 99) > 99
    }
    ...
    def 'Create fancy text fields with custom icons and a button.'(
        ...
        expect : 'The image is as expected.'
            Utility.similarityBetween(ui.get(JTextField), "components/heavily-customized-text-field.png", 97.5) > 97.5
    ...
    def 'Configure a custom paint for the font of your components.'(
        ...
        expect : 'The image is as expected.'
            Utility.similarityBetween(ui.get(JBox), "components/font-style-with-custom-paint.png", 98) > 98
