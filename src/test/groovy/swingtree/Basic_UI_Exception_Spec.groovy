    ...
    def 'The given factory methods do not accept null arguments.'(
        ...
        where :
            illegalAction << [
                    ...
                    {UI.panel().onMouseEnter(null, null)},
                    {UI.panel().onMouseExit(null, null)},
                    {UI.panel().onMouseEnterGreedy(null)},
                    {UI.panel().onMouseExitGreedy(null)},
                    ...
                    {UI.slider((UI.Axis)null)},
                    {UI.slider((UI.Axis)null, 1, 10, 3)},
                    {UI.slider(UI.Axis.HORIZONTAL).onChange(null)},
                    ...
                    {UI.panel((Val<Layout>)null)},
                    {UI.spinner((Var<?>)null)},
                    {UI.spinner((SpinnerModel)null)},
                    {UI.toolBar((UI.Axis)null)},
                    {UI.toolBar((Val)null)},
    ...
    def 'Certain Swing-Tree UI builder, do not allow you to use nullable properties.'(
        ...
        where :
            illegalAction << [
                    ...
                    { UI.panel(Val.ofNullable(Layout, Layout.mig(UI.FILL))) },
