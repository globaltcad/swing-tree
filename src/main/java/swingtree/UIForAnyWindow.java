	...
	public final I withOnCloseOperation( UI.OnWindowClose onClose ) {
		...
		return _with( thisWindow -> {
					if ( thisWindow instanceof JFrame )
						...
						log.warn(SwingTree.get().loggingMarker(), "Cannot set close operation on window of type: {}", thisWindow.getClass().getName());
		       })
			   ._this();
	}
					...
					_onKeyStroke( key.code, e -> {
                        _runInApp(()-> {
                            try {
                                ...
                                log.error(SwingTree.get().loggingMarker(), "Error occurred while processing key press event.", ex);
                            }
                        });
					}, thisWindow );
		       })
						...
						@Override public void focusGained(FocusEvent e) {
							_runInApp(()->{
								try {
									...
									log.error(SwingTree.get().loggingMarker(), "Error occurred while processing focus gain event.", ex);
								}
							});
						}
					});
						...
						@Override public void focusLost(FocusEvent e) {
							_runInApp(()->{
								try {
									...
									log.error(SwingTree.get().loggingMarker(), "Error occurred while processing focus loss event.", ex);
								}
							});
						}
					});
						...
						@Override public void windowClosing( WindowEvent e ) {
							_runInApp(()->{
								try {
									...
									log.error(SwingTree.get().loggingMarker(), "Error occurred while processing window closing event.", ex);
								}
							});
						}
					});
						...
						@Override public void windowClosed( WindowEvent e ) {
							_runInApp(()->{
								try {
									...
									log.error(SwingTree.get().loggingMarker(), "Error occurred while processing window closed event.", ex);
								}
							});
						}
					});
						...
						@Override public void windowOpened( WindowEvent e ) {
							_runInApp(()->{
								try {
									...
									log.error(SwingTree.get().loggingMarker(), "Error occurred while processing window opened event.", ex);
								}
							});
						}
					});
						...
						@Override public void windowIconified( WindowEvent e ) {
							_runInApp(()->{
								try {
									...
									log.error(SwingTree.get().loggingMarker(), "Error occurred while processing window iconified event.", ex);
								}
							});
						}
					});
						...
						@Override public void windowDeiconified( WindowEvent e ) {
							_runInApp(()->{
								try {
									...
									log.error(SwingTree.get().loggingMarker(), "Error occurred while processing window deiconified event.", ex);
								}
							});
						}
					});
						...
						@Override public void windowActivated( WindowEvent e ) {
							_runInApp(()->{
								try {
									...
									log.error(SwingTree.get().loggingMarker(), "Error occurred while processing window activated event.", ex);
								}
							});
						}
					});
						...
						@Override public void windowDeactivated( WindowEvent e ) {
							_runInApp(()->{
								try {
									...
									log.error(SwingTree.get().loggingMarker(), "Error occurred while processing window deactivated event.", ex);
								}
							});
						}
					});
						...
						@Override public void windowStateChanged( WindowEvent e ) {
							_runInApp(()->{
								try {
									...
									log.error(SwingTree.get().loggingMarker(), "Error occurred while processing window state changed event.", ex);
								}
							});
						}
					});
