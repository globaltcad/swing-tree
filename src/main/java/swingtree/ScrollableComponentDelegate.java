...
public final class ScrollableComponentDelegate
{
    ...
    static ScrollableComponentDelegate of(
        ...
        if ( content instanceof Scrollable) {
            ...
            // Measuring the view is by far the most expensive thing in this factory method,
            // so it happens at most once, and only if one of the two flags is really read:
