...
public final class Tab
{
    ...
    public final Tab isSelectedIf( boolean isSelected ) {
        if ( _isSelected != null )
            log.warn(SwingTree.get().logMarker(), "Selection flag already specified!", new Throwable("Stack trace for debugging purposes."));
    ...
    public final Tab isEnabledIf( boolean isEnabled ) {
        if ( _isEnabled != null )
            log.warn(SwingTree.get().logMarker(), "Enabled flag already specified!", new Throwable("Stack trace for debugging purposes."));
    ...
    public final Tab withIcon( Icon icon ) {
        ...
        if ( _icon != null )
            log.warn(SwingTree.get().logMarker(), "Icon already specified!", new Throwable("Stack trace for debugging purposes."));
    ...
    public final Tab withHeader( JComponent headerComponent ) {
        ...
        if ( _headerComponent != null )
            log.warn(SwingTree.get().logMarker(), "Header component already specified!", new Throwable("Stack trace for debugging purposes."));
    ...
    public final Tab add( UIForAnySwing<?,?> contents ) {
        if ( _contents != null )
            log.warn(SwingTree.get().logMarker(), "Content component already specified!", new Throwable("Stack trace for debugging purposes."));
