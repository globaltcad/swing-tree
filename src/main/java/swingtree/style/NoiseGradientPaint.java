    ...
    private final class NoiseGradientPaintContext implements PaintContext
    {
        ...
        public @Nullable Raster getRaster(
            ...
            try {
                ...
                // The rotation is a property of the paint, not of the pixel, so its
                // trigonometry is done once here instead of a quarter of a million
                ...
                // Two nested loops rather than one flat one with a division and a
                // remainder per pixel: at a quarter of a million pixels per tile those
                // two integer divisions are not free.
                int base = 0;
