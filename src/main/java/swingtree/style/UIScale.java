...
public class UIScale
{
    ...
    private static boolean isUserScalingEnabled() {
        return StyleSystemProperties.getBoolean( StyleSystemProperties.UI_SCALE_ENABLED, true );
    }
    ...
    private static void setUserScaleFactor( float scaleFactor, boolean normalize ) {
        if( normalize ) {
            if( scaleFactor < 1f ) {
                scaleFactor = StyleSystemProperties.getBoolean( StyleSystemProperties.UI_SCALE_ALLOW_SCALE_DOWN, false )
