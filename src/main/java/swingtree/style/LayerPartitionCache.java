...
final class LayerPartitionCache
{
    ...
    /**
     *  Updates this partition cache from a new render configuration to invalidate
     *  an existing cache entry, update the cache hit counter of an entry or create
     *  a new entry (No buffer allocation: that happens on demand after some cache hits)
     *
