 ...
 *  extensions of a custom <i>Look and Feel</i> which desires to integrate with the SwingTree style engine.<br>
 ...
 *  <ul>
 *      <li>
 *          1. Gathering style information to the <i>SwingTree</i> style engine
 *          by invoking the {@link #style(ComponentStyleDelegate)} implementation.
 *      </i>
 *      <li>
 *          2. Checking if {@link #canForwardPaintingToSwingTree()} returns {@code true} and then expecting
 *          the {@link javax.swing.plaf.ComponentUI#paint(Graphics, JComponent)} to delegate to <i>SwingTree</i>s
 *          {@link swingtree.style.ComponentExtension#paintBackground(Graphics, boolean, Consumer)} method.
 *      </i>
 *  </ul>
...
public interface SwingTreeStyledComponentUI<C extends JComponent> {
     ...
     *  the main way in which <i>SwingTree</i> renders its style onto the specific component type.<br>
     ...
     *  </p>
     * @return A flag which informs <i>SwingTree</i> if  it can rely on your {@link javax.swing.plaf.ComponentUI}
